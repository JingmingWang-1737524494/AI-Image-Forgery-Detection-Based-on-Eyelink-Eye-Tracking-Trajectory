...
The 30 plant/animal images presented in random order during the experiment are available at the following link

| Dataset Categories        | Type    |
|---------------------------|---------|
| animals and plants(dzw)    | https://huggingface.co/datasets/JingmingWang/AI-generated-Image-Detection/blob/main/dzw_picture.zip  | 
| food still life(msjw)       | https://huggingface.co/datasets/JingmingWang/AI-generated-Image-Detection/blob/main/msjw_picture.zip | 
| natural scenery(zrfg)      | https://huggingface.co/datasets/JingmingWang/AI-generated-Image-Detection/blob/main/zrfg_picture.zip   |
...
- File naming: `{categories}-{TRIAL_INDEX}.png` (e.g., `dzw-1.png` corresponds to TRIAL_INDEX=1 of animals and plants)
...
|---------------------------|---------|-----------------------------------------------------------------------------|
| RECORDING_SESSION_LABEL   | String  | Participant ID                                                              |
